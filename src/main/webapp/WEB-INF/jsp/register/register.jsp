...
<main>
	<center>
		<img class="responsive-img" style="width: 250px;" src="https://res.cloudinary.com/nerdzonia/image/upload/v1543461601/nerdzoniaicon.ico" />
		<div class="section"></div>
	 
		<h5 class="indigo-text">Cadaste-se na NerdZonia</h5>
		<div class="section"></div>
	
	<div class="container">
	  <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
	
		<form class="col s12" method="post" action="sendRegister">
		<div class='row'>
		...
		<div class='row'>
			...
			<label style='float: right;'>
				<a class='pink-text' href='login'><b>Já é cadastrado?</b></a>
			</label>
		</div>
	...
	<div class="footer-copyright grey darken-1">
		<div class="container">
			...
			<a class="grey-text text-lighten-5 right" href="https://materializecss.com/">Materialize</a>
		</div>
	</div>
</main>
