...
<body>
  <nav class="red darken-4">
    <div class="nav-wrapper">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a href="Home.html"><i class="material-icons left">close</i>Sair</a></li>
      </ul>
    </div>
  </nav>
  ...
  <ul class="sidenav" id="slide-out">
    ...
    <li><a href="#" class="waves-effect"><i class="material-icons">person</i>Perfi</a></li>
    ...
    <li><a href="Home.html" class="waves-effect"><i class="material-icons">close</i>Sair</a></li>
  </ul>
         ...
         <div class="grid-example col s12 m4">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="img/cartaz-poster-jogador-n-1-brasil.png" width="700" height="199">
                </div>
                <div class="card-content">
                  <span class="card-title activator grey-text text-darken-4">Jogador Numero 1º<i class="material-icons right">more_vert</i></span>
          ...
          <div class="grid-example col s12 m4">
              <div class="card">
                  <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="img/batman.jpg" width="700" height="200">
                  </div>
                  <div class="card-content">
                    <span class="card-title activator grey-text text-darken-4">Batman - O Cavaleiro das Trevas<i class="material-icons right">more_vert</i></span>
                    <p><a href="#" class="waves-effect waves-light btn small red"><i class="material-icons left">play_arrow</i>Assista Agora</a></p>
                  </div>
                  <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Sinopse<i class="material-icons right">close</i></span>
            ...
            <div class="grid-example col s12 m4">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <img class="activator" src="img/the hobbit.jpg" width="700" height="200">
                    </div>
                    <div class="card-content">
                      <span class="card-title activator grey-text text-darken-4">O Hobbit - A Desolação de Smaug<i class="material-icons right">more_vert</i></span>
                      <p><a href="#" class="waves-effect waves-light btn small red"><i class="material-icons left">play_arrow</i>Assista Agora</a></p>
                    </div>
                    <div class="card-reveal">
                      <span class="card-title grey-text text-darken-4">Sinopse<i class="material-icons right">close</i></span>
                      <p>Ao lado de um grupo de anões e de Gandalf, Bilbo segue em direção à Montanha Solitária, onde deverá ajudar seus companheiros a retomar a Pedra de Arken. O problema é que o artefato está perdido em meio a um tesouro protegido pelo temido dragão Smaug.</p>
                    </div>
                  </div>
              </div>
        </div>
